...
CMD+=" --train_manifest=${TRAIN_MANIFEST:-$DATA_DIR/librispeech-train-clean-100-wav.json,$DATA_DIR/librispeech-train-clean-360-wav.json,$DATA_DIR/librispeech-train-other-500-wav.json}"
